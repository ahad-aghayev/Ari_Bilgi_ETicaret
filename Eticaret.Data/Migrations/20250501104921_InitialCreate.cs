    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreateDate", "Email", "Guid", "IsActive", "IsAdmin", "Name", "Password", "Phone", "Surname", "UserName" },
                values: new object[] { 1, new DateTime(2025, 5, 1, 13, 49, 20, 151, DateTimeKind.Local).AddTicks(6825), "aghayev.ahad@gmail.com", new Guid("00000000-0000-0000-0000-000000000000"), true, true, "Test", "123456", null, "User", "Admin" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreateDate", "Description", "Image", "IsActive", "IsTopMenu", "Name", "OrderNo", "ParrentId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 1, 13, 49, 20, 152, DateTimeKind.Local).AddTicks(1491), null, null, true, true, "Elektronik", 1, 0 },
                    { 2, new DateTime(2025, 5, 1, 13, 49, 20, 152, DateTimeKind.Local).AddTicks(1504), null, null, true, true, "Bilgisayar", 2, 0 }
                });
